...
//reference: http://wada811.blogspot.com/2013/04/android-log-util.html
public class LogUtils {
    ...
    public static void d(int message){
        if(isDebug){
            Log.d(TAG, getMetaInfo() + String.valueOf(message));
        }
    }
    ...
    public static void d(String messageKey, String messageValue){
        if(isDebug){
            Log.d(TAG, getMetaInfo() + null2str(messageKey) + ":" + null2str(messageValue) );
        }
    }

    public static void d(String messageKey, int messageValue){
        if(isDebug){
            Log.d(TAG, getMetaInfo() + null2str(messageKey) + ":" + null2str(String.valueOf(messageValue)));
        }
    }

    public static void d(String messageKey, boolean messageValue){
        if(isDebug){
            Log.d(TAG, getMetaInfo() + null2str(messageKey) + ":" + null2str(String.valueOf(messageValue)));
        }
    }
